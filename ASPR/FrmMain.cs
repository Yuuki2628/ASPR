        ...
        private void UpdateStats()
        {
            ...
            if (topTen[0, 0] != "")
            {
                ...
                if(!gotEm)
                {
                    ...
                    double strength = Math.Round(((GetDouble(enemyStats[1]) * GetDouble(enemyStats[3])) + (GetDouble(enemyStats[1]) * GetDouble(enemyStats[4])) + (GetDouble(enemyStats[2]) * GetDouble(enemyStats[5]))), 2);
